...
The `core/` directory (located at `./canvas-design/core/`) contains professional PIL helper modules. Import what you need:
...
See `./canvas-design/references/` for shared design references (palettes, typography, composition, formats).
