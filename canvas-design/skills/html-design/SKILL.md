...
- Read `./canvas-design/references/formats.md` for dimensions and safe zones
- Read `./canvas-design/references/color-palettes.md` for curated palettes
- Read `./canvas-design/references/typography-pairings.md` for font combinations
- Read `./canvas-design/references/composition-guide.md` for layout techniques
- Read `./canvas-design/references/anti-slop-checklist.md` for forbidden patterns
...
**Font path base:** `file:///Users/jaypokharna/Desktop/Shared%20Folder/Shared%20Folder/python/claude-skills/canvas-design/skills/canvas-design/canvas-fonts/`

```css
@font-face {
    font-family: 'BigShoulders';
    src: url('file:///Users/jaypokharna/Desktop/Shared%20Folder/Shared%20Folder/python/claude-skills/canvas-design/skills/canvas-design/canvas-fonts/BigShoulders-Bold.ttf') format('truetype');
    font-weight: 700;
    font-style: normal;
}
```
...
1. Write HTML to `/tmp/canvas-design-{timestamp}.html`
