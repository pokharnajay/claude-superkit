"""
render.py — HTML rendering utilities for the canvas-design render-engine.
...
FONTS_DIR = Path(__file__).resolve().parent.parent / "canvas-design" / "canvas-fonts"
...
def write_temp_html(html: str, prefix: str = "canvas-design") -> str:
