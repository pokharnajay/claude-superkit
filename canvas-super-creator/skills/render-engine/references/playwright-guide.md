...
Quick reference for the Playwright browser automation tools used in the canvas-super-creator render pipeline.
...
```
url: "file:///tmp/canvas-super-creator-1234567890.html"
```
